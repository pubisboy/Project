	...
	<div style="width: 58.5%; padding-top: 30px;">
		<div class="row">
				...
				<div class="row"
					...
					<div class="col-xs-2" style="padding: 0px;">
						<div
							...
							align="left">
							<b style="font-size: 14px; color: #666666; letter-spacing: -1px;">상품
								합계금액</b>
						</div>
						<div>
							<span id="amount"></span>
					...
					<div class="col-xs-8"
						...
						<div
							style="background-color: #f1f1f1; height: 43px; padding-top: 10px; padding-left: 20px;"
							align="left">
							<b style="font-size: 14px; color: #666666; letter-spacing: -1px;">할인
								/ 적립금 사용 금액</b>
						</div>
						<div
							style="background-color: #e6e6e6; padding-left: 45px; height: 30px; font-size: 12.5px; padding-top: 7px;"
							align="left">
						...
						<div
							...
							align="left">
							<b style="color: #737373;">기본할인</b> 이벤트 할인(0)원0원
						</div>
						<div style="padding: 10px; width: 90%; font-size: 11.5px"
							align="left">
							<b style="color: #737373;">쿠폰할인</b> <input type="text"
								id="onecoupon"> <a href="javascript:popupOpen();"
								style="color: #262626">
								<button id="couponlist">쿠폰조회 및 적용</button>
							</a> 사용가능한 쿠폰 <b style="color: #ff1a75;">${clist.size() }</b>장 <span
								id="discount"></span>
						</div>
						<div
							style="background-color: #e6e6e6; padding-left: 45px; height: 30px; color: #ff1a75; font-size: 12.5px; padding-top: 7px;"
							align="left">
							<b style="color: #404040;">적립금 사용 금액</b><small
								style="font-size: 11px;">사용가능 적립금 0원</small>
						</div>
						<div align="left"
							style="width: 90%; padding: 10px; border-bottom: 1px solid #d9d9d9; font-size: 11.5px">
							<b style="color: #737373;">상품 적립금</b> <input type="radio"
								name="chk_point" value="save" />적립 <input type="radio"
								name="chk_point" value="use" />즉시사용(상품 적립금<span id="point"></span>원)
						</div>
						<div align="left"
							style="width: 90%; padding: 10px; font-size: 11.5px">
							<b style="color: #737373;">보유 적립금</b> <input type="text"
								id="consume" value="" />원<input type="checkbox" id="application">전액사용(보유적립금${point.POINT }원)
						</div>
						<div></div>
					</div>
					<div class="col-xs-2" style="padding: 0px;">
			...
			<div class="col-sm-12" style="padding-top: 40px;">
				...
				<div class="row"
					style="border-bottom: 2px solid gray; border-top: 2px solid black; font-size: 12px;">
					<div class="col-xs-2"
