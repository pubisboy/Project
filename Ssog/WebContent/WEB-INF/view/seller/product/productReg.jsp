...
<table style="height: 100%; width: 100%;" border="1">  
	...
	<option value="${i.NUM }">${i.NAME }</option>
	 ...
	 <input type="file" name="pro_img" style="display: none;" id="img_upload"><button style="margin-top: 5px;" id="img_btn" type="button">사진 등록</button>
	...
	<tr style="height: 52%;"><td style=" background-color: #eaeaea;">상품 상세</td><td colspan="3"> 
		<textarea id="pro_detail" style="width: 100%; height: 100%; resize: none;" name="pro_detail" required ></textarea> 
	</td></tr>   
