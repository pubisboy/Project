	...
	<tbody>
		<c:forEach items="${list }" var="i" varStatus="vs">
			<tr>
				...
				<td>${i.NUM }</td>
				<td align="left"><a
					href="/admin/management/counsel/counsel_user_detail.ja?num=${i.NUM }&type=${params.type }&value=${params.value}&state=${params.state}&reply=${params.reply}&sort=${params.sort}">${i.TITLE }</a></td>
				<td>${i.USER_ID }</td>
