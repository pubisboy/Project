		...
		<div class="col-sm-2">
			<div style="border-top: 2px solid black;height: 100px;width: 200px;"> 
				<a href="/member/myinfo/info.j"
					style="text-decoration: none; color: black;"><button style="width: 100%; height: 100%;"><span
			...
			<ul class="nav nav-stacked nav-pills" style="margin-top: 0px; border-left: 1px solid #d9d9d9; border-right: 1px solid #d9d9d9; border-bottom: 1px solid #d9d9d9; width: 200px;">
				<li class="${ac eq 'orderlist' ? 'ac' : '' }"><a href="/member/myinfo/orderlist.j"
					style="text-decoration: none; color: #404040; border-bottom: 2px dotted #d9d9d9; width: 90%; margin-left: 10px; font-size: 13px;">주문내역</a></li>
				
				<li class="${ac eq 'shoppingbasket' ? 'ac' : '' }"><a href="/cart/form.j"
					style="text-decoration: none; color: #404040; border-bottom: 2px dotted #d9d9d9; width: 90%; margin-left: 10px; font-size: 13px;">장바구니</a></li> 
				<li class="${ac eq 'coupon' ? 'ac' : '' }"><a
					data-toggle="collapse" data-parent="#accordion" href="#collapse1"
					style="text-decoration: none;  color: #404040; width: 90%; margin-left: 10px; font-size: 13px; padding-bottom: 0px;">쿠폰/적립금</a></li> 
				<div id="collapse1" class="panel-collapse collapse in" >
					<div class="panel-body">
						<a href="/member/myinfo/couponlist.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">할인쿠폰</a><br /> <a
							href="/member/myinfo/save.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">적립금</a><br />
					</div>
				</div>
				<li class="${ac eq 'mycontents' ? 'ac' : '' }"><a
					data-toggle="collapse" data-parent="#accordion" href="#collapse2"
					style="text-decoration: none; color: #404040;width: 90%; margin-left: 10px; font-size: 13px; padding-bottom: 0px;border-top: 2px dotted #d9d9d9;">나의 컨텐츠</a></li>
				<div id="collapse2" class="panel-collapse collapse in">
					<div class="panel-body">
						<a href="/member/myinfo/counsel.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">1:1 문의</a><br />
						<a href="/member/myinfo/qna.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">상품 Q&A</a><br />
						<a href="" style="color: #999999; margin-left: 10px; font-size: 12px;">상품평</a><br />
					</div>
				</div>
				<li class="${ac eq 'mypage' ? 'ac' : '' }"><a
					data-toggle="collapse" data-parent="#accordion" href="#collapse3"
					style="text-decoration: none; color: #404040; width: 90%; margin-left: 10px; font-size: 13px; padding-bottom: 0px;border-top: 2px dotted #d9d9d9;">나의정보</a></li>
				<div id="collapse3" class="panel-collapse collapse in"> 
					<div class="panel-body">
						<a href="/member/myinfo/info_revise.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">회원정보수정</a><br />
						<a href="/member/myinfo/userpass.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">비밀번호수정</a><br />
						<a href="/member/myinfo/leave.j"
							style="text-decoration: none; color: #999999; margin-left: 10px; font-size: 12px;">회원탈퇴</a><br />
					</div>
				</div>
			</ul>
		</div>
					...
					<div class="row">
						<div class="col-xs-3 col-sm-6"
							...
							<dl>
								...
								<p style="font-size: 20px; padding-left: 60px;padding-top: 7px;">${grade.GRADE }</p>
							</dl>
						</div>
						<div class="col-xs-3 col-sm-6"
							style="width: 50%; margin-top: 7px; margin-bottom: 10px;" align="center">
				...
				<div class="col-sm-6"
					...
					<div class="row">
						<div class="col-xs-3 col-sm-6"
							style="width: 50%; margin-top: 10px;">
							<dl>
								<dt style="font-size: 13px; padding-bottom: 7px;">My Wallet</dt>
								<dd>
						...
						<div class="col-xs-3 col-sm-6"
							...
							<a href="/member/myinfo/info.j" style="color: #262626;"><button
									style="font-size: 12px; width: 60px; height: 60px">쿠폰<p style="letter-spacing: -1px;margin-bottom: 0px;">다운로드</p> 
								</button></a>
						</div>
					</div>
				</div>
